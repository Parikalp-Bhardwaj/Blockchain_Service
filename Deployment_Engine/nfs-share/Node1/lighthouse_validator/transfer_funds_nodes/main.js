...
const keystoreFolderPath = '/Node-1/execution/keystore'; // Replace with the path to your keystore folder
const password = ''
...
async function processKeystoreFile(keystoreFilePath) {
  ...
  fs.readdir(keystoreFolderPath, async (err, files) => {
    ...
    const directory = '/Node-1/lighthouse_validator/validator_keys/';
