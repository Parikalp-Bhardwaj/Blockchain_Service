...
const keystoreFolderPath = '/Node-3/execution/keystore'; // Replace with the path to your keystore folder
const password = '';
...
async function processKeystoreFile(keystoreFilePath) {
  ...
  fs.readdir(keystoreFolderPath, async (err, files) => {
    ...
    const directory = '/Node-3/lighthouse_validator/validator_keys/';
