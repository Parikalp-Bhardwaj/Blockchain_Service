...
geth account new --password <(echo "$password") --datadir "/Node-4/execution/"
...
keystore_dir="/Node-4/execution/keystore"
chmod 777 -R /Node-4/execution/keystore/
...
output_file="/shared-files/Node-4-address.txt"
