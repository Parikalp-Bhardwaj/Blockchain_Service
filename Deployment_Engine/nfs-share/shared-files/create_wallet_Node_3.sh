...
geth account new --password <(echo "$password") --datadir "/Node-3/execution/"
...
keystore_dir="/Node-3/execution/keystore"

chmod 777 -R /Node-3/execution/keystore/
...
output_file="/shared-files/Node-3-address.txt"
