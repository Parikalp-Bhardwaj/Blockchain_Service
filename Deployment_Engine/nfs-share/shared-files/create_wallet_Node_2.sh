...
geth account new --password <(echo "$password") --datadir "/Node-2/execution/"
...
keystore_dir="/Node-2/execution/keystore"

chmod 777 -R /Node-2/execution/keystore/
...
output_file="/shared-files/Node-2-address.txt"
